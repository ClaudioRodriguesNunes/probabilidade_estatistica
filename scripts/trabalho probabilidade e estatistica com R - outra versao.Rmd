...
stations    <- read_csv("stations.csv", show_col_types = FALSE)    %>% clean_names()
station_day <- read_csv("station_day.csv", show_col_types = FALSE) %>% clean_names()
city_day    <- read_csv("city_day.csv", show_col_types = FALSE)    %>% clean_names()
